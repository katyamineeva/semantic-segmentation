...
imgResult = cv2.imread('top_potsdam_2_10_label.tif')
imgIdeal = cv2.imread('top_potsdam_2_11_label.tif')
...
if (imgResult.shape != imgIdeal.shape):
	...
	for (obj in objectTypes):
		...
		f1[obj] = (2 * precision * recall) / (precision + recall)
